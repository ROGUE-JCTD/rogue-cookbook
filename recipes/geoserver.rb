...
cookbook_file "geonode-geoserver-ext-2.4-SNAPSHOT-challenge.jar" do
  path File.join(node['tomcat']['webapp_dir'], 'geoserver/WEB-INF/lib/geonode-geoserver-ext-2.4-SNAPSHOT-challenge.jar')
